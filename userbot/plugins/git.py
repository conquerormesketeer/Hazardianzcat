...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/conquerormesketeer/Hazardianzcat) to open this bot source code\
        \nClick [here](https://github.com/Conquerormesketeer/Hazpack) to open supported link for heroku",
    )
